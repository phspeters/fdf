...
/*   Updated: 2024/02/07 21:11:07 by pehenri2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Sets the initial values of the camera and map parameters.
 * Gets the proportion of the map to fill the window, and sets the initial
 * offsets and zoom of the camera to centralize the image in the window. It also
 * sets the initial offsets of the map so that the (0,0) coordinate is at the
 * middle of the image.
 * 
