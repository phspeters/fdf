...
/*   Updated: 2024/02/09 10:58:11 by pehenri2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Creates the isometric projection of the map and sets it as the current
 * map. It copies the parallel projection to the isometric projection, pixel by
 * pixel and then applies the isometric transformation to each pixel.
 * 
